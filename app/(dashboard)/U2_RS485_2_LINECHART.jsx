...
export default function U2_RS485_2_LINECHART() {
  const [sensorData, setSensorData] = useState([]);
  const [liveSensorData, setLiveSensorData] = useState({ U2_RS485_2: null });
  const [liveGraphSensorData, setLiveGraphSensorData] = useState({ U2_RS485_2: null });
      ...
      <Text style={[styles.sensorTitle, { marginLeft: 8 }]}>
        ...
        <View style={styles.dataBox}>
          <Text style={styles.dataValue}>
            {liveSensorData["U2_RS485_2"]?.windSpeedmsData}
          </Text>
          <Text style={styles.dataLabel}>Wind Speed(m/s)</Text>
        </View>
        <View style={styles.dataBox}>
          <Text style={styles.dataValue}>
            {liveSensorData["U2_RS485_2"]?.totalSpeedData}
          </Text>
          <Text style={styles.dataLabel}>Total Speed</Text>
        </View>
        <View style={styles.dataBox}>
          <Text style={styles.voltageDataValue}>
            {liveSensorData["U2_RS485_2"]?.batteryVoltageData}
          </Text>
