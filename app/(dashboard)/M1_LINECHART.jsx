...
export default function M1_LINECHART() {
  const [sensorData, setSensorData] = useState([]);
  const [liveSensorData, setLiveSensorData] = useState({ M1: null });
  const [liveGraphSensorData, setLiveGraphSensorData] = useState({ M1: null });
